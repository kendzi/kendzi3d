...
public class RoofType2v0 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double recHeight, double recWidth,
        ...
        Vector3dc normalTop = new Vector3d(0, l1, -roofHeight).normalize();

        Vector3dc normalBottom = new Vector3d(0, l1, roofHeight).normalize();
        ...
        Vector3dc planeLeftPoint = new Vector3d(leftMiddlePoint.x(), roofHeight, -leftMiddlePoint.y());
        Vector3dc planeRightPoint = new Vector3d(rightMiddlePoint.x(), roofHeight, -rightMiddlePoint.y());
