 ...
 *
 */
public class RoofType0_3 extends RoofType0 {

    @Override
    public RoofTypeAliasEnum getPrefixKey() {
        return RoofTypeAliasEnum.ROOF_TYPE0_3;
    }
    ...
    public RoofTypeOutput buildRectangleRoof(RectangleRoofTypeConf conf) {
        ...
        return build(conf.getBuildingPolygon(), conf.getRecHeight(), conf.getRecWidth(), conf.getRectangleContur(), h1, h2, l1, l2, l3, 0, type, conf.getRoofTextureData());
    }
}
