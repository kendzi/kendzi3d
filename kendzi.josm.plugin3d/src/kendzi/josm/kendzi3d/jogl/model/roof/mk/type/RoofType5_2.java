...
//        rto.setRoofHooksSpaces(rhs);
    ...
    private double[] createTextureOffsets(List<CrossSectionElement> crossSection) {
    ...
    private MultiPolygonList2d[] createMP(PolygonList2d borderPolygon, LinePoints2d[] lines) {
    ...
    private Plane3d [] createPlanes(List<CrossSectionElement> crossSection) {
     ...
     * @return
     */
    public LinePoints2d[] createLines(List<CrossSectionElement> crossSection) {
