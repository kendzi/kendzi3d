...
public class Road extends AbstractModel {
     ...
     * List of road points.
     */
    private List<Point2D.Double> list = new ArrayList<Point2D.Double>();
	...
	public void buildModel() {
        ...
        if (this.list.size() > 1) {
            ...
            Point2D.Double beginPoint = this.list.get(0);
            for (int i = 1; i < this.list.size(); i++) {
                Point2D.Double endPoint = this.list.get(i);
                ...
                // left border
                int wbi1 = meshWalls.addVertex(new Point3d(
                        beginPoint.x + borderX, 0.0d, -(beginPoint.y + borderY)));
                // left part of road
                int wbi2 = meshWalls.addVertex(new Point3d(
                        beginPoint.x + normX, 0.1d, -(beginPoint.y + normY)));
                // middle part of road
                int wbi3 = meshWalls.addVertex(new Point3d(
                        beginPoint.x, 0.15d, -(beginPoint.y)));
                // right part of road
                int wbi4 = meshWalls.addVertex(new Point3d(
                        beginPoint.x - normX, 0.1d, -(beginPoint.y - normY)));
                // right border
                int wbi5 = meshWalls.addVertex(new Point3d(
                        beginPoint.x - borderX, 0.0d, -(beginPoint.y - borderY)));



                        // left border
                int wei1 = meshWalls.addVertex(new Point3d(
                        endPoint.x + borderX, 0.0d, -(endPoint.y + borderY)));
                        // left part of road
                int wei2 = meshWalls.addVertex(new Point3d(
                        endPoint.x + normX, 0.1d, -(endPoint.y + normY)));
                        // middle part of road
                int wei3 = meshWalls.addVertex(new Point3d(
                        endPoint.x, 0.15d, -(endPoint.y)));
                        // right part of road
                int wei4 = meshWalls.addVertex(new Point3d(
                        endPoint.x - normX, 0.1d, -(endPoint.y - normY)));
                        // right border
                int wei5 = meshWalls.addVertex(new Point3d(
                        endPoint.x - borderX, 0.0d, -(endPoint.y - borderY)));
    ...
    private class TextureData {
        ...
        /**
         * @param pLenght the lenght to set
         */
