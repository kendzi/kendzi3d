...
public class NewBuildingLayer implements Layer {
    ...
    {
        try {
            this.buildingNodeMatcher = SearchCompiler.compile("((building=* & -building=no & -building\\:parts=*) | building\\:part=yes) & -child type=building & (-child (type=multipolygon & (building=* |  building\\:part=*)))", false, false);
        ...
        try {
            this.buildingMatcher = SearchCompiler.compile("((building=* & -building=no& -building\\:parts=*) | building\\:part=yes) & -child type=building & (-child (type=multipolygon & (building=* |  building\\:part=*)))", false, false);
        ...
        try {
            this.buildingRelationMatcher = SearchCompiler.compile(
                    "(type=multipolygon  & ((building=* & -building=no & -building\\:parts=*) | building\\:part=yes)  & -child type=building) | type=building", false, false);
