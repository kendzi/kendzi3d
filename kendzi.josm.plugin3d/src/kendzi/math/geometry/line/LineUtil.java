...
public class LineUtil {
	 ...
	 * @param secondLinePoint second point of line it have to be different from first point
	 * @param lineSegmentA begin of line segment
	 * @param lineSegmentB end of line segment
	 * @return if line is crossing line segment
	 */
	public static boolean isLineCrossLineSegment(Point2d firstLinePoint, Point2d secondLinePoint, Point2d lineSegmentA, Point2d lineSegmentB) {
