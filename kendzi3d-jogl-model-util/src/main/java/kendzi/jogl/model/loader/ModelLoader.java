...
public class ModelLoader {
     ...
     * @Deprecated it should be created new factory class for replacing filds in
     *             model it should not be part of loading code.
     */
    @Deprecated
    public static Model load(String source, String replaceTextureMaterialName, String replaceTextureNewKey,
            ResourceService urlReciverService) throws ModelLoadException {
